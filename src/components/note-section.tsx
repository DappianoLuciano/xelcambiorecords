  ...
  return (
    <section className="min-h-screen bg-white px-6 py-20 md:px-12 md:py-32 pb-40">
      <div className="max-w-[1400px] 2xl:max-w-[1700px] mx-auto space-y-32">
        ...
        <div ref={(el) => { sectionsRef.current[0] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
        ...
        <div ref={(el) => { sectionsRef.current[1] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
        ...
        <div ref={(el) => { sectionsRef.current[2] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
        ...
        <div ref={(el) => { sectionsRef.current[3] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
        ...
        <div ref={(el) => { sectionsRef.current[4] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
        ...
        <div ref={(el) => { sectionsRef.current[5] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
        ...
        <div ref={(el) => { sectionsRef.current[6] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
        ...
        <div ref={(el) => { sectionsRef.current[7] = el }} className="grid grid-cols-1 xl:grid-cols-[240px_minmax(450px,600px)_240px] 2xl:grid-cols-[320px_minmax(550px,800px)_320px] gap-8 xl:gap-12 2xl:gap-20 items-start justify-end">
          {/* Columna 1: Título brutalist editorial */}
          <div className="block uppercase text-[#FF5A1F] self-start xl:-ml-12 mb-8 xl:mb-0" style={{
            fontFamily: 'var(--font-bebas)',
            fontSize: 'clamp(2.5rem, 7vw, 5rem)',
